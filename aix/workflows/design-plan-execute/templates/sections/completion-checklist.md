...
Agent note: keep this section in every implementation plan. During closeout,
update each item to completed or record the explicit gap, follow-up, or reason
it does not apply. Do not archive the plan until this checklist and the
plan-complete skill requirements agree. The human validation gate must remain
open until the developer has evaluated the built behavior or explicitly waived
manual validation with a recorded reason. -->
