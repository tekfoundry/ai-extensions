...
5. Harvest reusable lessons and update workflow guidance when appropriate.
6. Record final risks, follow-on work, documentation impact, and verification.
7. Archive only completed plans under `_docs/plans/completed/` with the
