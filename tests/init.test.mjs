...
test("initProject initializes an empty project with default sources and skills", async () => {
  await withProject(async (projectPath, defaults, cacheRoot) => {
    ...
    const securityReviewerRole = lockfile.roles.find((role) => role.activeName === "security-reviewer");
    ...
    assert.equal(result.materializedCount, 36);
    ...
    assert.equal(productDesignerRole.sourcePath, "roles/project-dev/product-designer.md");
    ...
    assert.equal(productDesignerRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/product-designer.md");
    assert.equal(productDesignerRole.activationPath, ".agents/roles/product-designer.md");
    assert.ok(requirementsEngineerRole);
    assert.equal(requirementsEngineerRole.source, "aix");
    assert.equal(requirementsEngineerRole.sourcePath, "roles/project-dev/requirements-engineer.md");
    ...
    assert.equal(requirementsEngineerRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/requirements-engineer.md");
    assert.equal(requirementsEngineerRole.activationPath, ".agents/roles/requirements-engineer.md");
    assert.ok(technicalArchitectRole);
    assert.equal(technicalArchitectRole.source, "aix");
    assert.equal(technicalArchitectRole.sourcePath, "roles/project-dev/technical-architect.md");
    ...
    assert.equal(technicalArchitectRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/technical-architect.md");
    assert.equal(technicalArchitectRole.activationPath, ".agents/roles/technical-architect.md");
    assert.ok(securityReviewerRole);
    assert.equal(securityReviewerRole.source, "aix");
    assert.equal(securityReviewerRole.sourcePath, "roles/project-dev/security-reviewer.md");
    assert.equal(securityReviewerRole.requested, false);
    assert.deepEqual(securityReviewerRole.owner, { kind: "workflow", name: "design-plan-execute" });
    assert.equal(securityReviewerRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/security-reviewer.md");
    assert.equal(securityReviewerRole.activationPath, ".agents/roles/security-reviewer.md");
    assert.ok(uxWriterRole);
    assert.equal(uxWriterRole.source, "aix");
    assert.equal(uxWriterRole.sourcePath, "roles/project-dev/ux-writer.md");
    assert.equal(uxWriterRole.requested, false);
    assert.deepEqual(uxWriterRole.owner, { kind: "workflow", name: "design-plan-execute" });
    assert.equal(uxWriterRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/ux-writer.md");
    assert.equal(uxWriterRole.activationPath, ".agents/roles/ux-writer.md");
    assert.ok(qualityEngineerRole);
    assert.equal(qualityEngineerRole.source, "aix");
    assert.equal(qualityEngineerRole.sourcePath, "roles/project-dev/quality-engineer.md");
    ...
    assert.equal(qualityEngineerRole.packagePath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/quality-engineer.md");
    assert.equal(qualityEngineerRole.activationPath, ".agents/roles/quality-engineer.md");
    assert.ok(documentationSpecialistRole);
    assert.equal(documentationSpecialistRole.source, "aix");
    assert.equal(documentationSpecialistRole.sourcePath, "roles/project-dev/documentation-specialist.md");
    ...
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/product-designer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/roles/product-designer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/requirements-engineer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/roles/requirements-engineer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/technical-architect.md")));
    assert.ok(existsSync(join(projectPath, ".agents/roles/technical-architect.md")));
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/security-reviewer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/roles/security-reviewer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/ux-writer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/roles/ux-writer.md")));
    assert.ok(existsSync(join(projectPath, ".agents/packages/workflows/aix/design-plan-execute/roles/project-dev/quality-engineer.md")));
...
test("run init initializes a project through the CLI command path", async () => {
  await withProject(async (_projectPath, defaults, cacheRoot) => {
    ...
    try {
      ...
      assert.match(result.stdout, /Materialized 36 workflow assets/);
